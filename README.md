...
```
cd existing_repo
git remote add origin https://gitlab.com/ideatesystems/angular_java.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/ideatesystems/angular_java/-/settings/integrations)
